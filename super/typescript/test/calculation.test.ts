...
import { calcTotalPrice, calcTotalPriceAppleThreeDiscount, calcTotalPriceAppleThreeDiscountWithTax, calcTotalPriceWithTabaccoTaxInclude, calcTotalPriceWithTax, IndexOutOfRangeError, NegativeNumError } from "../src/calculation";
